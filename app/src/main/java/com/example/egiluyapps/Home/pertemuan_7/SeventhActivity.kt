package com.example.egiluyapps.Home.pertemuan_7
...
import com.example.egiluyapps.databinding.ActivitySeventhBinding
...
class SeventhActivity : AppCompatActivity() {
    ...
    private fun replaceFragment(fragment: Fragment) {
        supportFragmentManager.beginTransaction()
            ...
            // .addToBackStack(null) // Hapus ini jika tidak ingin fragment menumpuk saat tekan back
            .commit()
    }
