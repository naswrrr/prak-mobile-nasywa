...
import com.example.egiluyapps.databinding.FragmentTabCBinding

class TabCFragment : Fragment() {

    // 1. Inisialisasi Binding (Wajib di Fragment agar tidak null pointer)
    private var _binding: FragmentTabCBinding? = null
    private val binding get() = _binding!!

    // 2. Data Produk dari Dosen
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 5. Setup RecyclerView dengan GridLayout (2 Kolom)
    ...
    // 6. Bersihkan binding saat fragment hancur (Good Practice)
